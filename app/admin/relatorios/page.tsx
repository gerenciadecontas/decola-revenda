...
export default function RelatoriosPage() {
  return (
    <GestorLayout currentPage="relatorios">
      <div style={{ background: COLORS.cardBg, border: `1px solid ${COLORS.borderColor}`, borderRadius: '18px', padding: '48px 24px', textAlign: 'center', color: COLORS.textSecondary }}>
        ...
        <h2 style={{ fontSize: '24px', fontWeight: 600, color: COLORS.textPrimary, marginBottom: '8px' }}>Relatórios</h2>
        <p>Gere e visualize relatórios</p>
      </div>
    </GestorLayout>
  );
}
